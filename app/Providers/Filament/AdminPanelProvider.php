...
use App\Filament\Widgets\BookingsTrendChartWidget;
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                ...
                BookingsTrendChartWidget::class,
                AppointmentStatusChartWidget::class,
                AppointmentsByBranchChartWidget::class,
            ])
            ->middleware([
